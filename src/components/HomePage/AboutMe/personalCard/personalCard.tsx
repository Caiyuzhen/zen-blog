...
const avatarData = [
	{
	  ...
	  describe:
		"I'm a UX designer and Front-end development enthusiasts from ShenZhen. My previous experience has focused on efficiency tools and communication tools. I'm also interested in some development libraries, so please feel free to share with me! 👏",
	},
	{
	  id: 1,
	  name: "avatar-02",
	  ...
	  describe:
		"My best work day is in the morning and evening, and my best work week is on Wednesday, if you want to discuss very important events with me you can refer to these times, of course there is no sleepiness or tiredness that a cup of coffee can not solve ☕️",
	},
	{
	  id: 2,
	  name: "avatar-03",
	  ...
	  describe:
		"In life, there are two cats accompany me, One is a silver gradient cat and one is a cream cat, they add more color to my life. If you are also a cat lover, welcome to communicate with me about the fun of cats 😄",
	},
	{
	  id: 3,
	  name: "avatar-04",
	  ...
	  describe:
		"I usually record my thoughts in Article and also share them on different social media to make more friends, of course most of them are unstructured personal reflections, the intention is to give people more information input. Welcome for follow my social media if you are interested 🌚",
	},
	{
	  id: 4,
	  name: "avatar-05",
	  ...
	  describe:
		"My preference is for interactive experiences and programming techniques that are a good bridge to the world. I believe that programming technology is the underlying code that makes the world run, and design is an effective means of pushing the boundaries of perception 🌍",
	},
	{
	  id: 5,
	  name: "avatar-06",
	  ...
	  describe:
		"I am rather nerdy, not good at sports, the only sport is playing badminton, if you also have this hobby welcome to find a weekend with me to play badminton, of course, I am not particularly good at badminton 😂",
	},
  ];
