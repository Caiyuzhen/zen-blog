	...
	return (
		<>
			...
			<div style={{textAlign: "center"}}>
				<img src={blink} style={{width: 400, borderRadius: 12}}/>
			</div>
			...
			<div style={{textAlign: "center"}}>
				<img src={poem} style={{width: 400, borderRadius: 12}}/>
			</div>
			...
			<div style={{textAlign: "center"}}>
				<img src={nelson} style={{width: 400, borderRadius: 12}}/>
			</div>
			<div style={{textAlign: "center"}}>
				<img src={hyperText} style={{width: 400, borderRadius: 12}}/>
			</div>
			...
			<div style={{textAlign: "center"}}>
				<img src={projectXANADU} style={{width: 400, borderRadius: 12}}/>
			</div>
			...
			<div style={{textAlign: "center"}}>
				<img src={interNet} style={{width: 400, borderRadius: 12}}/>
			</div>	
			...
			<div style={{textAlign: "center"}}>
				<img src={fb} style={{width: 400, borderRadius: 12}}/>
			</div>	
			...
			<div style={{textAlign: "center"}}>
				<img src={sonOfnet} style={{width: 400, borderRadius: 12}}/>
			</div>	
			...
			<div style={{textAlign: "center"}}>
				<img src={roam} style={{width: 400, borderRadius: 12}}/>
				<img src={trillium} style={{width: 400, borderRadius: 12}}/>
			</div>	
			...
			<div style={{textAlign: "center"}}>
				<img src={ubiquitousLink} style={{width: 400, borderRadius: 12}}/>
			</div>
